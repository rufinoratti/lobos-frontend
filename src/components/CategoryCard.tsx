...
export default function CategoryCard({
  ...
  return (
    <div className="bg-white rounded-3xl shadow-lg p-4 flex items-center gap-4 hover:shadow-xl active:scale-[0.97] active:shadow-2xl transition-all duration-200 w-[365px] mx-auto touch-manipulation">
